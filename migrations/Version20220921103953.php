 ...
 */
final class Version20220921103953 extends AbstractMigration
{
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE user ADD CONSTRAINT FK_8D93D649BF9019D4 FOREIGN KEY (atributs_id) REFERENCES role (id) ON UPDATE NO ACTION ON DELETE NO ACTION');
